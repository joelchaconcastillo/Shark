 ...
 */
//===========================================================================
#ifndef SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_BT5_H
#define SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_BT5_H
...
/**
* \brief Implements the benchmark function BT5.
*
...
* \ingroup benchmarks
*/
struct BT5 : public MultiObjectiveFunction
{
	BT5(std::size_t numVariables = 0) : m_objectives(2), m_handler(numVariables,0,1 ){
	...
	ResultType eval( const SearchPointType & x ) const {
		...
		int n = numberOfVariables();
                ...
                value[0] = x[0] + sum1;
                value[1] = (1.0 - x[0])*(1.0-x[0]*sin(8.5*M_PI*x[0])) + sum2;
