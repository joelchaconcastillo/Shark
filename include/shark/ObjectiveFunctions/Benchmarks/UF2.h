 ...
 */
//===========================================================================
#ifndef SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_UF2_H
#define SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_UF2_H
...
/**
* \brief Implements the benchmark function UF2.
*
...
* \ingroup benchmarks
*/
struct UF2 : public MultiObjectiveFunction
{
	UF2(std::size_t numVariables = 0) : m_objectives(2), m_handler(numVariables,0,1 ){
	...
	ResultType eval( const SearchPointType & x ) const {
		...
		CEC09::UF2(&(*(x.begin())), &(*(value.begin())), numberOfVariables());
		return value;
	}
private:
