 ...
 */
//===========================================================================
#ifndef SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_BT6_H
#define SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_BT6_H
...
/**
* \brief Implements the benchmark function BT6.
*
...
* \ingroup benchmarks
*/
struct BT6 : public MultiObjectiveFunction
{
	BT6(std::size_t numVariables = 0) : m_objectives(2), m_handler(numVariables,0,1 ){
