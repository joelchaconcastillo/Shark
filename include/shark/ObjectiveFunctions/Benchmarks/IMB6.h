 ...
 */
//===========================================================================
#ifndef SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_IMB6_H
#define SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_IMB6_H
...
/**
* \brief Implements the benchmark function IMB6.
*
...
* \ingroup benchmarks
*/
struct IMB6 : public MultiObjectiveFunction
{
	IMB6(std::size_t numVariables = 0) : m_objectives(3), m_handler(numVariables,0,1 ){
