 ...
 */
//===========================================================================
#ifndef SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_BT3_H
#define SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_BT3_H
...
/**
* \brief Implements the benchmark function BT3.
*
...
* \ingroup benchmarks
*/
struct BT3 : public MultiObjectiveFunction
{
	BT3(std::size_t numVariables = 0) : m_objectives(2), m_handler(numVariables,0,1 ){
	...
	void setNumberOfVariables( std::size_t numberOfVariables ){
        ...
        double S1(double x, double gamma)const
        {
	...
	ResultType eval( const SearchPointType & x ) const {
		...
		int n = numberOfVariables();
                ...
                value[0] = S1(x[0], 0.02) + sum1;
                value[1] = 1.0 - sqrt(S1(x[0], 0.02)) + sum2;
		return value;
	}
private:
