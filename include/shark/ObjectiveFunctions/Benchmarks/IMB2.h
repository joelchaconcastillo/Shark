 ...
 */
//===========================================================================
#ifndef SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_IMB2_H
#define SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_IMB2_H
...
/**
* \brief Implements the benchmark function IMB2.
*
...
* \ingroup benchmarks
*/
struct IMB2 : public MultiObjectiveFunction
{
	IMB2(std::size_t numVariables = 0) : m_objectives(2), m_handler(numVariables,0,1 ){
