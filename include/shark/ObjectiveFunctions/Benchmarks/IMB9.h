 ...
 */
//===========================================================================
#ifndef SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_IMB9_H
#define SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_IMB9_H
...
/**
* \brief Implements the benchmark function IMB9.
*
...
* \ingroup benchmarks
*/
struct IMB9 : public MultiObjectiveFunction
{
	IMB9(std::size_t numVariables = 0) : m_objectives(2), m_handler(numVariables,0,1 ){
	...
	ResultType eval( const SearchPointType & x ) const {
		...
		int n = numberOfVariables();
        	double gx = 0.0;
                ...
                value[0] = (1.0+gx)*cos(M_PI*x[0]*0.5);
                value[1] = (1.0+gx)*sin(M_PI*x[0]*0.5);
                return value;
	}
private:
