 ...
 */
//===========================================================================
#ifndef SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_IMB1_H
#define SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_IMB1_H
...
/**
* \brief Implements the benchmark function IMB1.
*
...
* \ingroup benchmarks
*/
struct IMB1 : public MultiObjectiveFunction
{
	IMB1(std::size_t numVariables = 0) : m_objectives(2), m_handler(numVariables,0,1 ){
