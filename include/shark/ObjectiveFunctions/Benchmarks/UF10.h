 ...
 */
//===========================================================================
#ifndef SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_UF10_H
#define SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_UF10_H
...
/**
* \brief Implements the benchmark function UF10.
*
...
* \ingroup benchmarks
*/
struct UF10 : public MultiObjectiveFunction
{
	UF10(std::size_t numVariables = 0) : m_objectives(3), m_handler(numVariables,0,1 ){
	...
	ResultType eval( const SearchPointType & x ) const {
		...
		CEC09::UF10(&(*(x.begin())), &(*(value.begin())), numberOfVariables());
		return value;
	}
private:
