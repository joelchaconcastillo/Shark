 ...
 */
//===========================================================================
#ifndef SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_UF5_H
#define SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_UF5_H
...
/**
* \brief Implements the benchmark function UF5.
*
...
* \ingroup benchmarks
*/
struct UF5 : public MultiObjectiveFunction
{
	UF5(std::size_t numVariables = 0) : m_objectives(2), m_handler(numVariables,0,1 ){
	...
	ResultType eval( const SearchPointType & x ) const {
		...
		CEC09::UF5(&(*(x.begin())), &(*(value.begin())), numberOfVariables());
		return value;
	}
private:
