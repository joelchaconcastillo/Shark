 ...
 */
//===========================================================================
#ifndef SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_IMB5_H
#define SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_IMB5_H
...
/**
* \brief Implements the benchmark function IMB5.
*
...
* \ingroup benchmarks
*/
struct IMB5 : public MultiObjectiveFunction
{
	IMB5(std::size_t numVariables = 0) : m_objectives(3), m_handler(numVariables,0,1 ){
	...
	ResultType eval( const SearchPointType & x ) const {
		...
		int n = numberOfVariables();
                ...
                value[0] = (1.0+gx)*cos(M_PI*x[0]*0.5)*cos(M_PI*x[1]*0.5);
                value[1] = (1.0+gx)*cos(M_PI*x[0]*0.5)*sin(M_PI*x[1]*0.5);
                value[2] = (1.0+gx)*sin(M_PI*x[0]*0.5);
                return value;
	}
private:
