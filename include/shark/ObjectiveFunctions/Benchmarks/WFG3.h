 ...
 */
//===========================================================================
#ifndef SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_WFG3_H
#define SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_WFG3_H
...
/**
* \brief Implements the benchmark function WFG3.
*
...
* \ingroup benchmarks
*/
struct WFG3 : public MultiObjectiveFunction
{
	WFG3(std::size_t numVariables = 0) : m_objectives(2), m_handler(numVariables,0,1){
	...
	ResultType eval( const SearchPointType & x ) const {
		m_evaluationCounter++;
		std::vector<double> f= Problems::WFG3(std::vector<double> ( &(*(x.begin())), &(*(x.begin()))+numberOfVariables()), m_position_k, numberOfObjectives());
