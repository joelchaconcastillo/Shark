 ...
 */
//===========================================================================
#ifndef SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_UF7_H
#define SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_UF7_H
...
/**
* \brief Implements the benchmark function UF7.
*
...
* \ingroup benchmarks
*/
struct UF7 : public MultiObjectiveFunction
{
	UF7(std::size_t numVariables = 0) : m_objectives(2), m_handler(numVariables,0,1 ){
	...
	ResultType eval( const SearchPointType & x ) const {
		...
		CEC09::UF7(&(*(x.begin())), &(*(value.begin())), numberOfVariables());
		return value;
	}
private:
