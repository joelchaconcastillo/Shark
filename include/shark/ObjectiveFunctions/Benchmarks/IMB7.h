 ...
 */
//===========================================================================
#ifndef SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_IMB7_H
#define SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_IMB7_H
...
/**
* \brief Implements the benchmark function IMB7.
*
...
* \ingroup benchmarks
*/
struct IMB7 : public MultiObjectiveFunction
{
	IMB7(std::size_t numVariables = 0) : m_objectives(2), m_handler(numVariables,0,1 ){
