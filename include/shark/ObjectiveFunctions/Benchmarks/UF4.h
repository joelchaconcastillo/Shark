 ...
 */
//===========================================================================
#ifndef SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_UF4_H
#define SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_UF4_H
...
/**
* \brief Implements the benchmark function UF4.
*
...
* \ingroup benchmarks
*/
struct UF4 : public MultiObjectiveFunction
{
	UF4(std::size_t numVariables = 0) : m_objectives(2), m_handler(numVariables,0,1 ){
	...
	ResultType eval( const SearchPointType & x ) const {
		...
		CEC09::UF4(&(*(x.begin())), &(*(value.begin())), numberOfVariables());
		return value;
	}
private:
