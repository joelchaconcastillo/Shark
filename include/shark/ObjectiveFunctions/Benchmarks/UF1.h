 ...
 */
//===========================================================================
#ifndef SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_UF1_H
#define SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_UF1_H
...
/**
* \brief Implements the benchmark function UF1.
*
...
* \ingroup benchmarks
*/
struct UF1 : public MultiObjectiveFunction
{
	UF1(std::size_t numVariables = 0) : m_objectives(2), m_handler(numVariables,0,1 ){
	...
	ResultType eval( const SearchPointType & x ) const {
		...
		CEC09::UF1(&(*(x.begin())), &(*(value.begin())), numberOfVariables());
		return value;
	}
private:
