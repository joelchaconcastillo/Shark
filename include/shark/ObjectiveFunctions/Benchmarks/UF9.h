 ...
 */
//===========================================================================
#ifndef SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_UF9_H
#define SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_UF9_H
...
/**
* \brief Implements the benchmark function UF9.
*
...
* \ingroup benchmarks
*/
struct UF9 : public MultiObjectiveFunction
{
	UF9(std::size_t numVariables = 0) : m_objectives(3), m_handler(numVariables,0,1 ){
	...
	ResultType eval( const SearchPointType & x ) const {
		...
		CEC09::UF9(&(*(x.begin())), &(*(value.begin())), numberOfVariables());
		return value;
	}
private:
