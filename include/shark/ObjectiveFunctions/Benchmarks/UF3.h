 ...
 */
//===========================================================================
#ifndef SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_UF3_H
#define SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_UF3_H
...
/**
* \brief Implements the benchmark function UF3.
*
...
* \ingroup benchmarks
*/
struct UF3 : public MultiObjectiveFunction
{
	UF3(std::size_t numVariables = 0) : m_objectives(2), m_handler(numVariables,0,1 ){
	...
	ResultType eval( const SearchPointType & x ) const {
		...
		CEC09::UF3(&(*(x.begin())), &(*(value.begin())), numberOfVariables());
		return value;
	}
private:
