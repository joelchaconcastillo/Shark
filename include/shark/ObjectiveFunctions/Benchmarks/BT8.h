 ...
 */
//===========================================================================
#ifndef SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_BT8_H
#define SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_BT8_H
...
/**
* \brief Implements the benchmark function BT8.
*
...
* \ingroup benchmarks
*/
struct BT8 : public MultiObjectiveFunction
{
	BT8(std::size_t numVariables = 0) : m_objectives(2), m_handler(numVariables,0,1 ){
