 ...
 */
//===========================================================================
#ifndef SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_IMB3_H
#define SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_IMB3_H
...
/**
* \brief Implements the benchmark function IMB3.
*
...
* \ingroup benchmarks
*/
struct IMB3 : public MultiObjectiveFunction
{
	IMB3(std::size_t numVariables = 0) : m_objectives(2), m_handler(numVariables,0,1 ){
