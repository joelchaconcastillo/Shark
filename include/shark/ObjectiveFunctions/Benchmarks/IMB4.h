 ...
 */
//===========================================================================
#ifndef SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_IMB4_H
#define SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_IMB4_H
...
/**
* \brief Implements the benchmark function IMB4.
*
...
* \ingroup benchmarks
*/
struct IMB4 : public MultiObjectiveFunction
{
	IMB4(std::size_t numVariables = 0) : m_objectives(3), m_handler(numVariables,0,1 ){
