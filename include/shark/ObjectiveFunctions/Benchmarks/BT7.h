 ...
 */
//===========================================================================
#ifndef SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_BT7_H
#define SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_BT7_H
...
/**
* \brief Implements the benchmark function BT7.
*
...
* \ingroup benchmarks
*/
struct BT7 : public MultiObjectiveFunction
{
	BT7(std::size_t numVariables = 0) : m_objectives(2), m_handler(numVariables,0,1 ){
