 ...
 */
//===========================================================================
#ifndef SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_BT2_H
#define SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_BT2_H
...
/**
* \brief Implements the benchmark function BT2.
*
...
* \ingroup benchmarks
*/
struct BT2 : public MultiObjectiveFunction
{
	BT2(std::size_t numVariables = 0) : m_objectives(2), m_handler(numVariables,0,1 ){
	...
	void setNumberOfVariables( std::size_t numberOfVariables ){
        ...
        double D2(double g, double theta)const
        {
	...
	ResultType eval( const SearchPointType & x ) const {
		...
		int n = numberOfVariables();
                double sum1 = 0.0, sum2 = 0.0, theta = 1.0/5.0;
                for(int j = 2; j <= n; j++)
                {
