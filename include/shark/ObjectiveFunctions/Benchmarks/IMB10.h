 ...
 * 
 *
 * \brief       Objective function IMB10
 * 
 * 
 *
 ...
 */
//===========================================================================
#ifndef SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_IMB10_H
#define SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_IMB10_H
...
/**
* \brief Implements the benchmark function IMB10.
*
...
* \ingroup benchmarks
*/
struct IMB10 : public MultiObjectiveFunction
{
	IMB10(std::size_t numVariables = 0) : m_objectives(3), m_handler(numVariables,0,1 ){
	...
	ResultType eval( const SearchPointType & x ) const {
		...
		int n = numberOfVariables();
                ...
                value[0] = (1.0+gx)*x[0]*x[1];
                value[1] = (1.0+gx)*x[0]*(1.0-x[1]);
                value[2] = (1.0+gx)*(1.0-x[0]);
                return value;
	}
private:
