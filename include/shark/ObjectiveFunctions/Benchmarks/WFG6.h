 ...
 */
//===========================================================================
#ifndef SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_WFG6_H
#define SHARK_OBJECTIVEFUNCTIONS_BENCHMARK_WFG6_H
...
/**
* \brief Implements the benchmark function WFG6.
*
...
* \ingroup benchmarks
*/
struct WFG6 : public MultiObjectiveFunction
{
	WFG6(std::size_t numVariables = 0) : m_objectives(2), m_handler(numVariables,0,1){
	...
	ResultType eval( const SearchPointType & x ) const {
		m_evaluationCounter++;
		std::vector<double> f= Problems::WFG6(std::vector<double> ( &(*(x.begin())), &(*(x.begin()))+numberOfVariables()), m_position_k, numberOfObjectives());
